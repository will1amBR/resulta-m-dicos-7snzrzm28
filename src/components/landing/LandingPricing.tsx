...
const plans = [
  {
    ...
    features: [
      'Ecossistema Modelo Aberto com concessões 24h',
      'Agenda e gestão de pacientes',
      'Prontuário SOAP com CID-10 e transcrição',
      'Documentos e receitas com QR Code público',
      'Exames com evolução temporal de marcadores',
      'Análise de interações medicamentosas por IA',
      '1 usuário',
    ],
    highlighted: false,
  },
  {
    ...
    features: [
      ...
      'Relatórios e Trilha de Auditoria LGPD (CSV/PDF)',
      'Até 5 médicos com aprovação de conselhos',
      'Teleconsulta WebRTC integrada',
      'Exportação de prontuário e receituário em PDF',
      'Portal do paciente com autorizações 24h',
      'Suporte prioritário',
    ],
    highlighted: true,
  },
